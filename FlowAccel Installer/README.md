...
└── output/                        ISCC writes FlowAccel-Setup-1.0.exe here
```
...
Output: `FlowAccel Installer\output\FlowAccel-Setup-1.0.exe` (~525 MB).
...
`setup-after-reboot.ps1`. New deployments should use `FlowAccel-Setup-1.0.exe`.
