...
;
; Produces output/JotFlow-Setup-1.0.5.exe

#define MyAppName        "JotFlow"
#define MyAppVersion     "1.0.5"
#define MyAppPublisher   "JotFlow"
#define MyAppURL         "http://localhost/"
#define MyAppExeName     "JotFlow-Setup-1.0.5.exe"
...
OutputDir=output
OutputBaseFilename=JotFlow-Setup-1.0.5
...
Filename: "powershell.exe"; \
    ...
    StatusMsg: "Installing JotFlow - watch the console window for live progress (this may take 10-15 minutes)..."; \
