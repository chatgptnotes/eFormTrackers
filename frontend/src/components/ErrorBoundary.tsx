...
export default class ErrorBoundary extends Component<Props, State> {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div className="app-page bg-navy-dark flex items-center justify-center p-4 sm:p-8">
          <div className="bg-navy rounded-2xl p-5 sm:p-8 max-w-md text-center space-y-4">
